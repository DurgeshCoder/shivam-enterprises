...
export const metadata: Metadata = {
  ...
  description:
    ...
    keywords:'Pure Dhoop Batti, Natural Incense Sticks, Handcrafted Dhoop Batti, Buy Dhoop Batti Online, Meditation Dhoop Batti, Spiritual Incense, Prem Vihar Colony Dhoop Batti, Haripur Kala Dehradun Dhoop Batti, Dehradun Incense Sticks, Relaxation Incense'
};
